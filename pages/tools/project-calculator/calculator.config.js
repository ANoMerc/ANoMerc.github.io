/**
════════════════════════════════════════════════════════════════════════════
ProjectWB Calculator Configuration v1.3
════════════════════════════════════════════════════════════════════════════
Содержит:
...
const CONFIG = {
  ...
  // Режимы калькулятора (для встраивания)
  CALC_MODES: {
    mini: {
      visibleFields: ['baseEffort', 'methodology', 'pmGrade'],
      label: 'Mini (HR)'
    },
    medium: {
      visibleFields: ['baseEffort', 'methodology', 'pmGrade', 'teamRoles', 'knownRiskReserve'],
      label: 'Medium (Manager)'
    },
    full: {
      visibleFields: 'all',
      label: 'Full (PM/Tools)'
